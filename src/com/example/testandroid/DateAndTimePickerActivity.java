	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		datepicker.init(year, month, day, new OnDateChangedListener() {
			...
			public void onDateChanged(DatePicker arg0, int year, int month,
					int day) {
				DateAndTimePickerActivity.this.year = year; // 改变year属性的值
				DateAndTimePickerActivity.this.month = month; // 改变month属性的值
				DateAndTimePickerActivity.this.day = day; // 改变day属性的值
		...
		timepicker.setOnTimeChangedListener(new OnTimeChangedListener() {
			...
			public void onTimeChanged(TimePicker view, int hourOfDay, int minute) {
				DateAndTimePickerActivity.this.hour = hourOfDay; // 改变hour属性的值
				DateAndTimePickerActivity.this.minute = minute; // 改变minute属性的值
