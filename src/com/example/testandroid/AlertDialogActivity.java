			...
			public void onClick(View v) {
				...
				alert.setButton(DialogInterface.BUTTON_NEGATIVE,"取消", new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Toast.makeText(AlertDialogActivity.this, "您单击了取消按钮",
				...
				alert.setButton(DialogInterface.BUTTON_POSITIVE,"确定", new OnClickListener() {
					...
					@Override
					public void onClick(DialogInterface dialog, int which) {
						Toast.makeText(AlertDialogActivity.this, "您单击了确定按钮",
								Toast.LENGTH_SHORT).show();
				...
				builder.setPositiveButton("确定", new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(!"".equals(result)){	
							...
							Toast.makeText(AlertDialogActivity.this, "您选择了[ "+result+" ]", Toast.LENGTH_LONG).show();
						}
					}
				});
				builder.create().show(); // 创建对话框并显示
