...
public class LiHuanDengPianActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lihuandengpian);
		...
		// 设置动画效果
				...
				imageSwitcher.setFactory(new ViewFactory() {
					...
					public View makeView() {
						ImageView imageView = new ImageView(LiHuanDengPianActivity.this); // 实例化一个ImageView类的对象
		...
		BaseAdapter adapter = new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					imageview = new ImageView(LiHuanDengPianActivity.this); // 实例化ImageView的对象
